#!/usr/bin/env python3
"""Stage one or more Aegis Code npm packages for release."""
...
GITHUB_REPO = "mithran-hq/aegis-code"
...
def tarball_name_for_package(package: str, version: str) -> str:
    if package in CODEX_PLATFORM_PACKAGES:
        platform = package.removeprefix("aegis-")
        return f"aegis-npm-{platform}-{version}.tgz"
