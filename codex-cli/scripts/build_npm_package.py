#!/usr/bin/env python3
"""Stage and optionally package the @mithran/aegis npm module."""
...
CODEX_NPM_NAME = "@mithran/aegis"

# `npm_name` is the local optional-dependency alias consumed by `bin/aegis.js`.
# The underlying package published to npm is always `@mithran/aegis`.
CODEX_PLATFORM_PACKAGES: dict[str, dict[str, str]] = {
    "aegis-linux-x64": {
        "npm_name": "@mithran/aegis-linux-x64",
        "npm_tag": "linux-x64",
    ...
    "aegis-linux-arm64": {
        "npm_name": "@mithran/aegis-linux-arm64",
        "npm_tag": "linux-arm64",
    ...
    "aegis-darwin-x64": {
        "npm_name": "@mithran/aegis-darwin-x64",
        "npm_tag": "darwin-x64",
    ...
    "aegis-darwin-arm64": {
        "npm_name": "@mithran/aegis-darwin-arm64",
    ...
    "aegis-win32-x64": {
        "npm_name": "@mithran/aegis-win32-x64",
        "npm_tag": "win32-x64",
    ...
    "aegis-win32-arm64": {
        "npm_name": "@mithran/aegis-win32-arm64",
        "npm_tag": "win32-arm64",
...
PACKAGE_EXPANSIONS: dict[str, list[str]] = {
    "aegis": ["aegis", *CODEX_PLATFORM_PACKAGES],
}

PACKAGE_NATIVE_COMPONENTS: dict[str, list[str]] = {
    "aegis": [],
    "aegis-linux-x64": ["aegis", "bwrap", "rg"],
    "aegis-linux-arm64": ["aegis", "bwrap", "rg"],
    "aegis-darwin-x64": ["aegis", "rg"],
    "aegis-darwin-arm64": ["aegis", "rg"],
    "aegis-win32-x64": ["aegis", "rg", "codex-windows-sandbox-setup", "codex-command-runner"],
    "aegis-win32-arm64": ["aegis", "rg", "codex-windows-sandbox-setup", "codex-command-runner"],
...
COMPONENT_DEST_DIR: dict[str, str] = {
    "bwrap": "aegis-resources",
    "aegis": "aegis",
    "codex-responses-api-proxy": "codex-responses-api-proxy",
    "codex-windows-sandbox-setup": "aegis",
    "codex-command-runner": "aegis",
    "rg": "path",
}


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build or stage the Aegis Code npm package.")
    parser.add_argument(
        "--package",
        choices=PACKAGE_CHOICES,
        default="aegis",
        help="Which npm package to stage (default: aegis).",
    )
    parser.add_argument(
        "--version",
        ...
        if release_version:
            ...
            if package == "aegis":
                print(
                    ...
                    "Verify the CLI:\n"
                    f"    node {staging_dir_str}/bin/aegis.js --version\n"
                    f"    node {staging_dir_str}/bin/aegis.js --help\n\n"
                )
...
def prepare_staging_dir(staging_dir: Path | None) -> tuple[Path, bool]:
    ...
    temp_dir = Path(tempfile.mkdtemp(prefix="aegis-npm-stage-"))
...
def stage_sources(staging_dir: Path, version: str, package: str) -> None:
    ...
    if package == "aegis":
        ...
        shutil.copy2(CODEX_CLI_ROOT / "bin" / "aegis.js", bin_dir / "aegis.js")
    ...
    if package == "aegis":
        ...
        package_json["optionalDependencies"] = {
            ...
            for platform_package in PACKAGE_EXPANSIONS["aegis"]
            if platform_package != "aegis"
        }
...
def run_npm_pack(staging_dir: Path, output_path: Path) -> Path:
    ...
    with tempfile.TemporaryDirectory(prefix="aegis-npm-pack-") as pack_dir_str:
