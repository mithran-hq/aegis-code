...
3. **Document behavior.** If your change affects user-facing behavior, update the README, inline help (`aegis --help`), or relevant example projects.
...
Together we can make Aegis Code CLI an incredible tool. **Happy hacking!** :rocket:
