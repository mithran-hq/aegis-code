...
#[derive(Debug, Parser)]
#[command(bin_name = "aegis plugin marketplace")]
...
#[derive(Debug, Parser)]
#[command(bin_name = "aegis plugin marketplace add")]
...
#[derive(Debug, Parser)]
#[command(bin_name = "aegis plugin marketplace upgrade")]
struct UpgradeMarketplaceArgs {
    marketplace_name: Option<String>,
}

#[derive(Debug, Parser)]
#[command(bin_name = "aegis plugin marketplace remove")]
